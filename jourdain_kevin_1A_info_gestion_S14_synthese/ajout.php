...
<body>
    ...
    <div id="main_box">
        ...
        <main id="main_content">
            ...
            <h2>Ajout d'un objet au stock</h2>
            <form method="POST" action="ajout.php">
                <label for="nom">Nom : </label><input name="newname" type="text" size="42" placeholder="Entrez le nom du produit">
                <br><br>
            ...
            <?php
                if(isset($_POST['submit2'])) {
                    $query2 = 'INSERT INTO stock (nomStock) VALUES ("'.$_POST["newname"].'")';
                    $rslt = $PDO->query($query2);
                    echo "objet ajouté, actualisation la page pour voir le résultat";
